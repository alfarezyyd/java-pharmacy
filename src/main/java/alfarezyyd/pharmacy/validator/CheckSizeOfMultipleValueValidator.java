...
public class CheckSizeOfMultipleValueValidator implements ConstraintValidator<CheckSizeOfMultipleValueConstraint, OrderMedicineCreateRequest> {
  @Override
  public boolean isValid(OrderMedicineCreateRequest value, ConstraintValidatorContext context) {
